...
/**
 * This is the model class for table "report_function_arg_value_mapping".
 *
 * The followings are the available columns in table 'report_function_arg_value_mapping':
 * @property integer $id
 ...
 */
class ReportFunctionArgValueMapping extends CActiveRecord
{
	/**
	...
	{
		return 'report_function_arg_value_mapping';
	}
	 ...
	 * @return ReportFunctionArgValueMapping the static model class
	 */
