...
/**
 * This is the model class for table "report_function_para_value".
 *
 * The followings are the available columns in table 'report_function_para_value':
 * @property integer $id
 * @property integer $report_function_mapping_id
 * @property integer $function_argument_map_id
 * @property string $value
 */
class ReportFunctionParaValue extends CActiveRecord
{
	/**
	...
	{
		return 'report_function_para_value';
	}
	 ...
	 * @return ReportFunctionParaValue the static model class
	 */
