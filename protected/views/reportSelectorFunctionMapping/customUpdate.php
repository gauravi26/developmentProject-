...
<html>
    ...
    <body>
        ...
        ?>
        <form class="functionActionForm" id="functionAction" method="post" action="<?php echo Yii::app()->createUrl('reportSelectorFunctionMapping/customUpdate'); ?>">
    ...
    <script>
        $(document).ready(function () {
            $('#report_id').on('change', function () {
                ...
                $.ajax({
                    url: 'index.php?r=reportSelectorFunctionMapping/loadModels',
                    type: 'POST',
                    dataType: 'json',
                    data: {reportId: reportId},
                    success: function (response) {
                        console.log(response);
        var reportColumns = response.reportColumns;
    console.log(reportColumns);
                        handleReportResponse(reportColumns.split(","));
                    },
                    error: function () {
...
//*******************************************************************************************************
        function fetchTargetColumns(index, count, Columncount, $actionDiv,actioncount) {
            ...
            $.ajax({
                url: 'index.php?r=reportSelectorFunctionMapping/fetchReportColumns',
                type: 'POST',
