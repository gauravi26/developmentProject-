...
echo CHtml::hiddenField('controllerId', $controllerId); // Populate hidden field with controller ID
echo CHtml::hiddenField('actionId', $actionId); // Populate hidden field with action ID
?>
...
<?php endforeach; ?>
  ...
  <script>function isInRange(value, minValue, maxValue) {
...
var conditionfunction = isInRange;
var functionPara = [10];
var actionStyle = changeBackgroundColor;
var actionPara = ['purple'];
